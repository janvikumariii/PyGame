...
class Game:
    ...
    def play_background_music(self):
        pygame.mixer.music.load("SnakeGame/resources/bg_music_1.mp3")
        pygame.mixer.music.play(-1, 0)

    def play_sound(self, sound_name):
        if sound_name == "crash":
            sound = pygame.mixer.Sound("SnakeGame/resources/crash.mp3")
        elif sound_name == "ding":
            sound = pygame.mixer.Sound("SnakeGame/resources/ding.mp3")
